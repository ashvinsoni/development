...
//Mail function
	...
	function send_email_old( $to , $subject = "" , $message = "" , $from_email = FROM_ADMIN_EMAIL , $from_name = FROM_EMAIL_NAME )
	{
		...
		//$mail->addAddress('viscus008@hotmail.com', 'This is a subject DBS');
