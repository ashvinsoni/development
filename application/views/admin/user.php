<!-- Content -->
<div class="content" data-ng-controller="UserCtrl">
	<div class="title">
		<h5>User</h5>		
	</div>
	<?php $attr = 'id="user_list"'; echo form_open( current_url() , $attr ); ?>
		<div class="widget mrt20" id="user_wrapper" data-ng-init="get_all_user_detail();">
			<div class="head">
				...
				<div class="dataTables_filter" id="roster_filter" test-directive>
					<label>Search: <input type="text" placeholder="type here..." name="filter_name" ng-keyup="get_all_user_detail()" ng-model="filter_name" uniform value="">
					<div class="srch"></div>
					</label>
				</div>
				<a href="<?php echo site_url( 'admin/user_detail_report' ); ?>" target="_blank" class="redBtn" style="display:inline-block;margin:5px 10px;padding:1px 5px 1px 5px;"> Export to CSV </a>
				<a href="<?php echo site_url( 'admin/send_emails' ); ?>" class="redBtn" style="display:inline-block;padding:1px 5px 1px 5px;margin-top:5px;"> Send email to all users </a>
			...
			<table cellpadding="0" cellspacing="0" width="100%" class="display resize tableStatic user_tbl" id="user_tbl">
				<thead>
					<tr class="roster_th">
						<th class="all_th" style="text-align:left;">
							<input type="checkbox" id="all" check-all checkFor="ui">
						</th>
				...
				<tbody>
					<tr ng-repeat="userData in user_data">												
						<td>
							<input type="checkbox" name="ui[]"  class="user_id" value="{{userData.user_id}}" data-mails="{{userData.email}}">
						</td>	
						...
						<td align="center">
							<img src="images/deactivate.png" alt="" ng-if="userData.is_banned==0" class="status_{{userData.user_id}}">
							<img src="images/active.png" alt="" ng-if="userData.is_banned==1" class="status_{{userData.user_id}}">
						</td>
					</tr>
				</tbody>
			</table>
...
<script type="text/javascript">
	...
	<?php if ( isset( $user ) )	echo 'user_list = '.json_encode( $user  ).';'; ?>
...
<section class="popupWrapper animated" id="sendemailpopup">
	<section class="popup-inner">
		<div class="content" id="container">
			<div class="title">
				<a href="javascript:void(0);" class="icon-close" onClick="closePopDiv('sendemailpopup', 'bounceOutUp');$('.formError').hide();"></a>
				<h5>Send Emails</h5>
			</div>
...
function openPopDiv(e)
{
	...
	if(document.getElementById("fade")){$("#fade").remove()}$('<div id="fade"></div>').appendTo($("body"));$("#fade").click(function(){closePopDiv(e)});compDiv=e;centerPopup(e);loadPopup(e)}function closePopDiv(e){compDiv=e;disablePopup(e)}function loadPopup(e){$("#fade").fadeIn(200);$("#"+e).addClass("bounceInDown").fadeIn(200);setTimeout(function(){$("#"+e).removeClass("bounceInDown")},1100)}function disablePopup(e){$("#fade").fadeOut(200);setTimeout(function(){$("#"+e).fadeOut(200).removeAttr("style")},200)}function centerPopup(e){var t=$(document).width();var n=$(document).height();var r=$("#"+e).height();var i=$("#"+e).width();arrPageScroll=___getPageScroll();arrPageSizes=___getPageSize();$("#"+e).css({position:"absolute",top:arrPageSizes[3]/2-$("#"+compDiv).height()/2+getScrollTop()+"px",left:t/2-i/2,"z-Index":99});ems=parseInt($("#"+e).css("top"));if(ems<0){$("#"+e).css({position:"absolute",top:10})}$("#fade").css({height:"100%",opacity:.6,width:"100%",backgroundColor:"#000",position:"fixed","z-index":"12",left:0,top:0})}function ___getPageSize(){var e,t;if(window.innerHeight&&window.scrollMaxY){e=window.innerWidth+window.scrollMaxX;t=window.innerHeight+window.scrollMaxY}else if(document.body.scrollHeight>document.body.offsetHeight){e=document.body.scrollWidth;t=document.body.scrollHeight}else{e=document.body.offsetWidth;t=document.body.offsetHeight}var n,r;if(self.innerHeight){if(document.documentElement.clientWidth){n=document.documentElement.clientWidth}else{n=self.innerWidth}r=self.innerHeight}else if(document.documentElement&&document.documentElement.clientHeight){n=document.documentElement.clientWidth;r=document.documentElement.clientHeight}else if(document.body){n=document.body.clientWidth;r=document.body.clientHeight}if(t<r){pageHeight=r}else{pageHeight=t}if(e<n){pageWidth=e}else{pageWidth=n}arrayPageSize=new Array(pageWidth,pageHeight,n,r);return arrayPageSize}function ___getPageScroll(){var e,t;if(self.pageYOffset){t=self.pageYOffset;e=self.pageXOffset}else if(document.documentElement&&document.documentElement.scrollTop){t=document.documentElement.scrollTop;e=document.documentElement.scrollLeft}else if(document.body){t=document.body.scrollTop;e=document.body.scrollLeft}arrayPageScroll=new Array(e,t);return arrayPageScroll}function getScrollTop(){var e=document.body.scrollTop;if(e==0){if(window.pageYOffset)e=window.pageYOffset;else e=document.body.parentElement?document.body.parentElement.scrollTop:0}return e}var compDiv;var arrPageScroll;var arrPageSizes=new Array;$(window).resize(function(){$("#fade").width($(window).width()).height($(document).height())});$(document).ready(function(){$("#fade").click(function(){closePopDiv(compDiv)});$(document).keydown(function(e){if(e.keyCode==27){closePopDiv(compDiv)}})});
//end
