...
<div class="content">
	...
	<?php $frm_attr = 'id="game_list" class="frm_input"'; echo form_open( current_url() , $frm_attr ); ?>
		<div class="stats">
			<ul>
				<li>
					<?php $attr = ' onchange="Games.SearchGameCancelled();"'; if ( isset( $sport) ) echo form_dropdown( 'league_id' , $sport ,'' , $attr ); ?>
				</li>
			</ul>
			<div class="fix"></div>
		</div>
		...
		<div class="pagination">
			...
			<div class="per_page">
				<?php if ( isset( $per_page_limit ) ){ $attr = 'id="per_page_limit" onchange="Games.SearchGameCancelled();"'; echo form_dropdown( 'per_page_limit' , $per_page_limit , '' , $attr );  } ?>
