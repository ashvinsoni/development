...
(function(e) {
    ...
    e.fn.bannerscollection_zoominout = function(a) {
        ...
        return this.each(function() {
            ...
            c = E();
            a.enableTouchScreen && (a.fadeSlides && (p = Math.floor(1E5 * Math.random()), f.wrap('<div id="zoominoutParent_' + p + '" style="position:relative;" />'), e("#zoominoutParent_" + p).width(a.width + 1), e("#zoominoutParent_" + p).height(a.height)), -1 != c && 9 == c && a.fadeSlides && "opportune" == a.skin || (h.css("cursor", "url(" + a.absUrl + "),url(" + a.absUrl + "),move"), f.css("cursor", "url(" + a.absUrl + "),url(" + a.absUrl + "),move")), h.css("left", "0"), a.fadeSlides ? -1 != c && 9 == c && a.fadeSlides && "opportune" == a.skin || f.draggable({
                axis: "x",
                containment: "parent",
                distance: 10,
                start: function(a, b) {
