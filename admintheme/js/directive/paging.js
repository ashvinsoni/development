 ...
 *
 */
MdApp.directive('paging', function () {
    ...
    function setScopeValues(scope, attrs) {
        ...
        scope.activeClass = scope.activeClass || 'fg-button ui-button ui-state-disabled';
    ...
    function addRange(start, finish, scope) {
        ...
        for (i = start; i <= finish; i++) {
            ...
            var item = {
                value: i,
                title: 'Page ' + i,
                liClass: scope.page == i ? scope.activeClass : 'fg-button ui-button',
                action: function () {
    ...
    function addPrev(scope, pageCount) {
        ...
        var first = {
            value: '<<',
            title: 'First Page',
            liClass: disabled ? scope.disabledClass : 'fg-button ui-button toFirst ui-corner-tl ui-corner-bl',
            action: function () {
                if(!disabled) {
        ...
        var prev = {
            value: '<',
            title: 'Previous Page',
            liClass: disabled ? scope.disabledClass : 'fg-button ui-button previous',
            action: function () {
                if(!disabled) {
    ...
    function addNext(scope, pageCount) {
        ...
        var last = {
            value: '>>',
            title: 'Last Page',
            liClass: disabled ? scope.disabledClass : 'fg-button ui-button last ui-corner-tr ui-corner-br',
            action: function () {
                if(!disabled){
        ...
        var next = {
            value: '>',
            title: 'Next Page',
            liClass: disabled ? scope.disabledClass : 'fg-button ui-button next',
            action: function () {
                if(!disabled){
    ...
    return {
        ...
        template: 
			'<div ng-hide="Hide" ng-class="ulClass"> ' +
				'<span ' +
				'title="{{Item.title}}" ' +
				'ng-class="Item.liClass" ' +
				'ng-click="Item.action()" ' +
				'ng-repeat="Item in List" ng-bind="Item.value">' +
            '</div>',
        replace: true,
